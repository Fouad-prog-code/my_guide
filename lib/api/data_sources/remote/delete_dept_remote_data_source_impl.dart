...
@Injectable(as: DeleteDeptRemoteDataSource)
class DeleteDeptRemoteDataSourceImpl implements DeleteDeptRemoteDataSource {
  ApiServices apiServices;

  DeleteDeptRemoteDataSourceImpl({required this.apiServices});
  @override
  Future<UpdateOrDeleteObjectResponse> deleteDepartment(
    ...
    try {
      var response = await apiServices.deleteDepartment(
        deptId,
        'Bearer $token',
      );
