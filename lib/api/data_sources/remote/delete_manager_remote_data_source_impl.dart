...
class DeleteManagerRemoteDataSourceImpl implements DeleteManagerRemoteDataSource {
  ApiServices apiServices;
  DeleteManagerRemoteDataSourceImpl({required this.apiServices});

  @override
  Future<UpdateOrDeleteUserResponse> deleteManager(int managerId, String token) async {
    try {
      var response = await apiServices.deleteManager(managerId, 'Bearer $token');
